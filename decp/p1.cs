...
//     public static int dataLengthInBit = 114 * 8;
...
//             () =>
//             {
//                 var x = new byte[] { 1, 2, 3, 4, 5, 6, 7, 8, 9, 0, 0, 0, 0, 0, 0 };
//                 var rs = RSEncodePacket.Create(x);
//                 // rs.Bytes[0] = 0;
//                 // rs.Bytes[1] = 0;
//                 // rs.Bytes[2] = 0;
//                 // rs.Bytes[3] = 0;
//                 // rs.Bytes[4] = 0;
//                 // rs.Bytes[5] = 0;
//                 var drs = RSDecodePacket.Create(rs.Bytes);

//                 // var field = new GenericGF(285, 256, 0);

//                 // var encode = new ReedSolomonEncoder(field);
//                 // var decode = new ReedSolomonDecoder(field);

//                 // drs.Bytes[1] = 0;
//                 // drs.Bytes[2] = 0;
//                 // drs.Bytes[3] = 0;
//                 // encode.Encode(x, 6);
//                 foreach (var d in drs.Bytes)
//                 {
//                     Console.WriteLine(d);
//                 }
...
//             var x = RSEncodePacket.Create(data);
//             Console.WriteLine(x.Bytes.Length);
//             await transmitter.Packets.WriteAsync(x, cts.Source.Token);
