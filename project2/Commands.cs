...
public static class CommandTask
{
    ...
    )
    {
        ...
        var player =
            render switch { null => new MMDeviceEnumerator().GetDefaultAudioEndpoint(DataFlow.Render, Role.Multimedia),
        ...
        var wasapiOut = new WasapiOut(player, AudioClientShareMode.Exclusive, true, 2);
